...
func TestTickerIdxs(t *testing.T) {
	tests := map[string]struct {
		...
		"Basic CRNT": {
			...
			expectedTickerIdxs: map[string][]int{"CRNT": {1}},
		}, "Basic CPSH": {
			...
			expectedTickerIdxs: map[string][]int{"CPSH": {1}},
			...
			expectedTickerIdxs: map[string][]int{"MP": {1}},
		}, "STPK Buy": {
			...
			expectedTickerIdxs: map[string][]int{"STPK": {1}},
		}, "BNGO NoOp": {
			...
			expectedTickerIdxs: map[string][]int{"BABA": {1}},
		}, "BNGO High Buy": {
			...
			expectedTickerIdxs: map[string][]int{"BNGO": {1}, "PACB": {1}},
		}, "FRSX Buy": {
			...
			expectedTickerIdxs: map[string][]int{"FRSX": {1}},
		}, "IMMR Buy": {
			...
			expectedTickerIdxs: map[string][]int{"IMMR": {1}},
		}, "SAMA Buy": {
			...
			expectedTickerIdxs: map[string][]int{"SAMA": {1}},
		}, "BFT Buy": {
			...
			expectedTickerIdxs: map[string][]int{"BFT": {1}},
		}, "FEAC Buy": {
			...
			expectedTickerIdxs: map[string][]int{"FEAC": {1}},
		}, "NNOX Buy": {
			...
			expectedTickerIdxs: map[string][]int{"NNOX": {1}},
		}, "AQB Sell, MP Buy": {
			...
			expectedTickerIdxs: map[string][]int{"AQB": {0}, "MP": {5}},
		}, "MP Buy": {
			...
			expectedTickerIdxs: map[string][]int{"MP": {0}},
		}, "KNDI Sell": {
			...
			expectedTickerIdxs: map[string][]int{"KNDI": {0}},
		}, "FEAC Buy 2": {
